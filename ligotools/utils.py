...
def plot_matched_filter(pcolor, det, time, timemax, SNR, strain_whitenbp, template_match, template_fft, datafreq, data_psd, freqs, fs, eventname, plottype, tevent, d_eff):
    # -- Plot the result
